    ...
    <div className="min-h-screen bg-white p-8 print:p-4 flex items-center justify-center" style={{ fontFamily: "'Times New Roman', serif" }}>
      <div className="w-[210mm] max-w-full mx-auto bg-white text-[14pt]">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-base font-semibold text-black mt-3">
        ...
        <div className="relative">
          ...
          <div className="flex justify-between mb-8 relative">
            <div className="w-[30%] text-center">
              <div className="border-2 border-black bg-white p-3 rounded-md min-h-[60px] flex items-center justify-center">
                <p className="text-sm font-medium text-black">Процедурный кабинет</p>
              </div>
              <div className="h-12 w-0.5 bg-black mx-auto relative mt-1">
                <div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[6px] border-r-[6px] border-t-[8px] border-l-transparent border-r-transparent border-t-black"></div>
              </div>
            </div>
          ...
          <div className="flex justify-between mb-4 relative">
            <div className="w-[30%] flex justify-center">
              <div className="h-10 w-0.5 bg-black relative mt-1">
                <div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[6px] border-r-[6px] border-t-[8px] border-l-transparent border-r-transparent border-t-black"></div>
              </div>
            </div>
            <div className="w-[30%] flex justify-center">
          ...
          {/* Первый контейнер */}
          <div className="mb-6">
            <div className="border-2 border-black bg-gray-100 p-3 rounded-md mx-auto max-w-[80%]">
              <p className="text-sm text-center font-medium text-black">
                сбрасывается в одноразовый контейнер с дезинфекцией<br />Авансепт 2%
              </p>
            </div>
            <div className="h-10 w-0.5 bg-black mx-auto relative mt-1">
              <div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[6px] border-r-[6px] border-t-[8px] border-l-transparent border-r-transparent border-t-black"></div>
            </div>
          </div>
          ...
          <div className="flex justify-center mb-6">
            <div className="w-0.5 h-10 bg-black relative mt-1">
              <div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[6px] border-r-[6px] border-t-[8px] border-l-transparent border-r-transparent border-t-black"></div>
            </div>
          </div>
          ...
          <div className="flex justify-center mb-6 relative">
            ...
            <div className="absolute top-0 left-[25%] w-0.5 h-10 bg-black">
              <div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[6px] border-r-[6px] border-t-[8px] border-l-transparent border-r-transparent border-t-black"></div>
            </div>
            <div className="absolute top-0 right-[25%] w-0.5 h-10 bg-black">
              <div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[6px] border-r-[6px] border-t-[8px] border-l-transparent border-r-transparent border-t-black"></div>
            </div>
          </div>
